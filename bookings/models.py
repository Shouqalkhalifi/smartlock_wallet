...
class Booking(models.Model):
    ...
    smartlock_code = models.CharField(
        max_length=100, blank=True, null=True, help_text="PIN / key code from Igloohome"
    )
    smartlock_key_id = models.CharField(
        max_length=100, blank=True, null=True, help_text="Key ID from Igloohome"
    )
